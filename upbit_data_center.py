...
class UpbitDataCenter():
    ...
    def init_traders(self, coin_name):
        ...
        # time.sleep(0.1)
        # self.minute5_trader = Minute5Trader(coin_name, 120, src_logger)
        time.sleep(0.15)
        self.minute10_trader = Minute10Trader(coin_name, 200)
        #time.sleep(0.1)
        # self.minute15_trader = Minute15Trader(coin_name, 120, src_logger)
        #time.sleep(0.15)
        self.minute30_trader = Minute30Trader(coin_name, 200)
        time.sleep(0.15)
        self.minute60_trader = Minute60Trader(coin_name, 200)
        time.sleep(0.15)
